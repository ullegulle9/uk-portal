...
class SelectSml extends Component {
  constructor(props) {
    super(props);
    this.state = {
      active: false,
  ...
  render() {
    ...
    let options = this.props.options.map(o => {
      return <div key={o} className="drpdwn-option-sml" onClick={this.handleClick}>{o}</div>
    })
    view = 
    <div>
      <div className="drpdwn-head-sml">{this.props.title} 
